...
cap = cv2.VideoCapture("rtsp://root:jhsrobo@192.168.1.201/axis-media/media.amp")
while True:
...
if mode == 1:
	thresh = cv2.adaptiveThreshold(blurred ,255,cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY_INV,11,9)
